...
<body>
	<!-- header -->
      ...
      <input class="form-control" name="name" id="name" type="search" placeholder="Search" aria-label="Search">
	  <button class="btn btn-warning" id="search" name="submit" type="submit" value="search">Search</button>
    </form> -->
      ...
      aria-haspopup="true" aria-expanded="false">Track</button>
								...
								<a class="dropdown-item" href="all_songs.php"><b>All Songs</b></a>
						...
						<li class="nav-item mr- mt-2">
							<a class="nav-link scroll" href="reset_password.php">Reset Password</a>
						</li>
						<li class="nav-item mr- mt-2">
		...
		<div class="container">
			<div class="banner-text">
				<div class="slider-info text-right">
					<p style="color: White; font-size: 2rem"><?php echo "WELCOME ".$_SESSION['username'];?></p>

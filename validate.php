...
if(isset($_POST['forgot'])){
    ...
    //     $to=$email_address;
    //     $mail->setFrom('your email address', 'Music Records');
    ...
    //     You recently requested to reset your password for your Music Records account.Click the button below to reset it. <br>
    //     <br><br>
